...
class ConvBlock(nn.Module):
    ...
    def __init__(self, input_ch, output_ch, kernel_size, block_depth, dropout_p=0.):
        '''
        ...
        for i in range(block_depth):
            ...
            if dropout_p > 0:
                conv_list.append(nn.Dropout(dropout_p))

            conv_list.append(nn.GELU())
            input_ch = output_ch
...
class DownBlock(nn.Module):
    ...
    def __init__(self, input_ch, output_ch, kernel_size, block_depth, dropout_p):
        super().__init__()
...
class UpBlock(nn.Module):
    ...
    def __init__(self, input_ch, output_ch, kernel_size, block_depth, dropout_p):
        ...
        self.block = ConvBlock(input_ch, output_ch, kernel_size, block_depth, dropout_p)
